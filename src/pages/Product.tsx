          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Risk scoring and response for <span className="text-gradient">GenAI systems</span>
              </h1>
              <p className="text-lg text-muted-foreground mb-8">
                Get a go/no-go decision before shipping. Quantify risk, generate evidence, and gate releases with confidence.
              </p>
              ...
              <div className="bg-card rounded-xl border border-border/50 p-6">
                ...
                <div className="flex items-center justify-between p-4 bg-green-500/10 rounded-lg border border-green-500/30">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-semibold text-green-400">PASS</span>
                  </div>
              ...
              <div className="order-2 lg:order-1 bg-card rounded-xl border border-border/50 p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-background rounded border border-border">
                    ...
                    <span className="text-xs text-green-400">✓ No leaks</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-background rounded border border-border">
                  ...
                  <div className="flex items-center justify-between p-3 bg-background rounded border border-border">
                    ...
                    <span className="text-xs text-green-400">✓ None found</span>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 p-3 bg-background rounded border border-border">
                      <div className={`w-2 h-2 rounded-full ${log.status === 'success' ? 'bg-green-400' : 'bg-primary'}`} />
        ...
        <section className="py-16 lg:py-24 bg-muted/30">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
              See how ZROTrust.AI can help your team quantify and manage GenAI risk.
            </p>
            <Button size="lg" onClick={() => setIsDemoOpen(true)}>
              Request a Demo
              <ArrowRight className="ml-2 h-4 w-4" />
